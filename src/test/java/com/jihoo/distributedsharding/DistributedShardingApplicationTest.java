...
public class DistributedShardingApplicationTest {
    ...
    public void findByOrderId() {
        ...
        OrderEntity byOrderId = orderDao.findByOrderId(21L);
        log.info("byOrderId={}", byOrderId);
    }

    @Test
    public void findByUserId() {
        List<OrderEntity> byUserId = orderDao.findByUserId(525);
        log.info("byUserId={}", byUserId);
    }

    @Test
    public void findByUserIdAndOrderId() {
        List<OrderEntity> data = orderDao.findByUserIdAndOrderId(525,1646459030477L);
        log.info("byUserId={}", data);
    }
